...
| 13 | Dotmac ISP replacement rather than in-place Sub adoption | Proposed ADR 0012 and `pgm-dotmac-isp-replacement` choose a new independent thin assembly, but a draft moves no authority and cannot amend product first-cutover records. | Michael |
| 14 | Canonical target ISP assembly identity | The repository, runtime, independent database and deployment owner are deliberately `unassigned`; inferring them from the product name would create an unapproved control plane. | Michael |
| 15 | Enforceable legacy Sub permanent-domain change freeze | The intended exception classes are containment, evidence repair and migration adapters. The enforcement owner, detector, exception approval and sensitivity proof must be approved before the programme relies on the freeze. | Michael |
