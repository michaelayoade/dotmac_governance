...
| 13 | Coordinated Dotmac ISP construction and Sub cutover programme | Michael directed both tracks in the 2026-08-20 working session. Proposed ADR 0012 remains non-normative until his approval is attributable in GitHub and the accepted revision merges; the draft moves no authority and cannot amend product first-cutover records. | Michael |
