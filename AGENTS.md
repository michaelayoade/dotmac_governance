...
4. Run the local validation commands. **These are the whole local set** —
   ...
   ```bash
   python3 -m ruff check --select E4,E7,E9,F,I,B,UP agent_control gate_control programme_control standards_control tests/test_agent_control.py tests/test_check_commit_identity.py tests/test_check_receipts.py tests/test_check_validation_contract.py tests/test_gate_control.py tests/test_programme_control.py tests/test_standards_control.py tools/check_commit_identity.py tools/check_receipts.py tools/check_validation_contract.py tools/dotmac-agent tools/dotmac-gates tools/dotmac-programme tools/dotmac-standards
   python3 -m ruff format --check agent_control gate_control programme_control standards_control tests/test_agent_control.py tests/test_check_commit_identity.py tests/test_check_receipts.py tests/test_check_validation_contract.py tests/test_gate_control.py tests/test_programme_control.py tests/test_standards_control.py tools/check_commit_identity.py tools/check_receipts.py tools/check_validation_contract.py tools/dotmac-agent tools/dotmac-gates tools/dotmac-programme tools/dotmac-standards
   python3 -m mypy --strict --scripts-are-modules agent_control gate_control programme_control standards_control tools/check_commit_identity.py tools/check_receipts.py tools/check_validation_contract.py tools/dotmac-agent tools/dotmac-gates tools/dotmac-programme tools/dotmac-standards
