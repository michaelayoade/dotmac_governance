...
| 13 | Coordinated Dotmac ISP construction and Sub cutover programme | Proposed ADR 0012 and `pgm-dotmac-isp-replacement` require both the independent target-build track and the Sub source-readiness/cutover track while preserving one production authority per cohort. A draft moves no authority and cannot amend product first-cutover records. | Michael |
